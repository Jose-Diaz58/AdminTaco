      ...
      <div className="bg-white rounded-xl shadow-lg flex flex-col h-[calc(100vh-160px)] overflow-hidden border border-gray-100">
        ...
        <div className="grid grid-cols-2 gap-3 mt-4">
          <div className="bg-orange-400 bg-opacity-40 rounded-lg p-3">
            <p className="bg-orange-400 bg-opacity-40 rounded-lg p-3">Libres</p>
            <p className="text-2xl font-bold">{mesasLibres}</p>
          </div>
          {/* mesas ocupadas */}
          <div className="bg-orange-400 bg-opacity-40 rounded-lg p-3">
            <p className="bg-orange-400 bg-opacity-40 rounded-lg p-3">Cobro Pendiente</p>
